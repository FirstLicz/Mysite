    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('cj', '初级'), ('zj', '中级'), ('gj', '高级'), ('dj', '顶级')], max_length=2, verbose_name='等级')),
                ('learn_times', models.IntegerField(default=0, help_text='存储单位是分钟', verbose_name='学习时长')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_url', models.FileField(help_text='视频路劲', max_length=200, upload_to='course/video/%Y/%m', verbose_name='视频')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
